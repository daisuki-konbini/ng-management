...
.ant-breadcrumb > ant-breadcrumb-item:last-child a {
  color: rgba(0, 0, 0, 0.65);
}
nz-breadcrumb {
  display: block;
...
.ant-drawer-header-no-title .ant-drawer-close {
  ...
  padding-right: calc(14px - var(--scroll-bar));
}
.ant-drawer-header {
  position: relative;
  padding: 11px 16px;
...
div.ant-typography-edit-content {
  left: -8px;
  margin-top: -3px;
  margin-bottom: calc(1em - 2px - 2px);
}
